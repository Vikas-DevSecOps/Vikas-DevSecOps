...
[![Azure](https://img.shields.io/badge/Microsoft_Azure-Cloud-0078D4?logo=microsoftazure&logoColor=white)](https://azure.microsoft.com/)
...
<img src="https://skillicons.dev/icons?i=azure,terraform,docker,kubernetes,githubactions,git,github,powershell,linux,vscode" height="50" alt="Skill Icons" />

</div>

<br>

 <img src="https://skillicons.dev/icons?i=azure" height="28"/> **Microsoft Azure**
...
- Compute and storage — VM, VMSS, Storage Accounts, Managed Identities, Availability Zones
 ...
 <img src="https://skillicons.dev/icons?i=terraform" height="28"/> **Terraform (Infrastructure as Code)**
...
- Automating Azure Landing Zone components through Infrastructure as Code
 ...
 <img src="https://skillicons.dev/icons?i=githubactions,azure" height="28"/> **CI/CD & Automation**
...
- Managing release workflows with a focus on repeatability and rollback safety
 ...
 <img src="https://skillicons.dev/icons?i=docker,kubernetes" height="28"/> **Containers & Kubernetes**
...
- Managing rolling updates for zero-downtime application delivery
 ...
 <img src="https://skillicons.dev/icons?i=azure" height="28"/> **DevSecOps, Security & Governance**
...
- Managing Azure Key Vault, resource locks, resource tagging, and cost governance
 ...
 <img src="https://skillicons.dev/icons?i=azure" height="28"/> **Monitoring & Observability**
...
- Tracking metrics and activity logs to support proactive issue resolution
 ...
 <img src="https://skillicons.dev/icons?i=git,github,powershell,linux,vscode" height="28"/> **Version Control & Scripting**
...
```mermaid
flowchart LR
    A[Code Commit] --> B[GitHub Actions / Azure Pipelines]
    B --> C[Terraform Plan + IaC Scan]
    C --> D{Approval}
